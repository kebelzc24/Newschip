...
public class EnrollActivity extends BaseActivity {
    ...
    int[] images3 = new int[]{R.mipmap.zwt_01, R.mipmap.zwt_02,
            R.mipmap.zwt_03, R.mipmap.zwt_04, R.mipmap.zwt_05,
            R.mipmap.zwt_06, R.mipmap.zwt_07, R.mipmap.zwt_08,
            R.mipmap.zwt_09, R.mipmap.zwt_10, R.mipmap.zwt_11,
            R.mipmap.zwt_12, R.mipmap.zwt_13, R.mipmap.zwt_14};

    @Override
    protected int getLayoutView() {
        return R.layout.fp_enroll;
    }
...
//				+ mFingerList.size());
        ...
        InitAnimation();
        for (int i = 0; i < 15; i++) {
            array[i] = this.getApplicationContext().getResources()
                    .getDrawable(R.mipmap.zwt_00);
        }
        enrollStart();
    ...
    private void initToolbar() {
        ...
        mToolbar.setTitle(R.string.enroll_fingerprint);
    ...
    private void enrolling(int index, int progress, int area) {
        ...
        array[0] = EnrollActivity.this.getApplicationContext().getResources()
                .getDrawable(R.mipmap.zwt_00);
        for (int j = 0; j < bitValue.length; j++) {

            if (bitValue[j] == 1) {
                Log.d(TAG, "bitValue[j] == 1");
                array[j + 1] = EnrollActivity.this.getApplicationContext()
                        .getResources().getDrawable(images3[j]);
                overlayIndex = j;
            } else {
                array[j + 1] = EnrollActivity.this.getApplicationContext()
                        .getResources().getDrawable(images3[overlayIndex]);
        ...
        for (int k = 0; k < 15; k++) {
            ...
            ld.setLayerInset(k, 0, 0, 0, 0);
        }
        finger.setImageDrawable(ld);
    }
    ...
    private void enrollSuccess(final int index) {
        ...
        finger.setImageResource(R.mipmap.zwt_15);
