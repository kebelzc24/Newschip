...
import com.newschip.fingerprint.video.VideoBean;
import com.newschip.fingerprint.video.VideoPageAdapter;
 ...
 * @类名:	VideoListActivity
 * @创建者:	邱英健
 * @创建时间:	2015-8-17 下午3:18:39
 * @描述:	显示手机中的视频
 */
public class VideoListActivity extends BasePhotoActivity implements
    ...
    private class LoadVideoAsyncTask extends AsyncTask<Integer, Void, Integer> {
