...
import com.newschip.fingerprint.gallery.FileHideListAdapter.OnPhotoSelectListener;
...
public class FileHideListActivity extends BasePhotoActivity implements
        OnClickListener, OnPhotoSelectListener {

    private ArrayList<FileObject> mFileObject = null;// 存放名称
    private ListView mFileListView;
    private FileHideListAdapter mAdapter;
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            case DEHIDE_OK:
                ...
                getFileObjects(FileUtils.getFileHidePath());
                initViews();
                break;
            case DEHIDE_FAIL:
    ...
    private void initViews() {
        ...
        mCenterTitleText.setText("照片(" + mFileObject.size() + ")");
        mHideBtn.setText("恢复");
        mHideBtn.setOnClickListener(this);
        mFileListView = (ListView) findViewById(R.id.listView);
        mAdapter = new FileHideListAdapter(this, mFileObject);
...
//                String oldPath = Environment.getExternalStorageDirectory().getAbsolutePath()+"/favor";
