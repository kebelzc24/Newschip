package com.newschip.fingerprint.dialog;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    private FrameLayout mRenameFrame;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRenameFrame = (FrameLayout) findViewById(R.id.rename_frame);
        mRenameEdit = (EditText) findViewById(R.id.et_rename);
    ...
    public String getRenameStr() {
        return mRenameEdit.getText().toString();
    }
    ...
    private void restore() {
        ...
        mRenameFrame.setVisibility(View.GONE);
    ...
    private void changeAlertType(int alertType, boolean fromCreate) {
        ...
        if (mDialogView != null) {
            ...
            case CUSTOM_IMAGE_TYPE:
                ...
                break;
            case RENAME_TYPE:
                mRenameFrame.setVisibility(View.VISIBLE);
                break;
            }
            if (!fromCreate) {
                playAnimation();
