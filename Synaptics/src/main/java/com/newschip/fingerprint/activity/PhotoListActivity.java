...
import com.newschip.fingerprint.gallery.ImageBean;
import com.newschip.fingerprint.gallery.ImageSort;
import com.newschip.fingerprint.gallery.PhotoSetActivity;
 ...
 * @类名:	PhotoListActivity
 * @创建者:	邱英健
 * @创建时间:	2015-8-17 下午3:18:16
 * @描述:	显示手机中的相册
 */
public class PhotoListActivity extends BasePhotoActivity implements
